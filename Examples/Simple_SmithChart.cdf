...
NotebookDataLength[     82317,       1682]
NotebookOptionsPosition[     55044,       1094]
NotebookOutlinePosition[     81286,       1655]
CellTagsIndexPosition[     81175,       1649]
WindowTitle->The Smith Chart
WindowFrame->Normal*)
...
Cell["The Smith Chart", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`c$$ = 10, $CellContext`f$$ = 
    500, $CellContext`L$$ = 10, $CellContext`R$$ = 50, Typeset`show$$ = True, 
    Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`f$$], 500, "frequency MHz"}, 0, 1000, 1}, {{
       Hold[$CellContext`R$$], 50, "resistance \[CapitalOmega]"}, 0, 100, 
      1}, {{
       Hold[$CellContext`L$$], 10, "inductance nH"}, 0, 100, 1}, {{
       Hold[$CellContext`c$$], 10, "capacitance pF"}, 0, 100, 1}}, 
    Typeset`size$$ = {400., {198., 202.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    False, $CellContext`f$577380$$ = 0, $CellContext`R$577381$$ = 
    0, $CellContext`L$577382$$ = 0, $CellContext`c$577383$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`c$$ = 10, $CellContext`f$$ = 
        500, $CellContext`L$$ = 10, $CellContext`R$$ = 50}, 
      "ControllerVariables" :> {
        Hold[$CellContext`f$$, $CellContext`f$577380$$, 0], 
        Hold[$CellContext`R$$, $CellContext`R$577381$$, 0], 
        Hold[$CellContext`L$$, $CellContext`L$577382$$, 0], 
        Hold[$CellContext`c$$, $CellContext`c$577383$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> Show[$CellContext`smith, 
        Graphics[{
          Dynamic[
           Text[
            Style["\[CircleDot]", 24, Bold], {
             $CellContext`\[Xi][$CellContext`f$$, $CellContext`R$$, \
$CellContext`L$$, $CellContext`c$$], 
             $CellContext`\[Eta][$CellContext`f$$, $CellContext`R$$, \
$CellContext`L$$, $CellContext`c$$]}]], 
          Dynamic[
           Text[
            Row[{
              Style["z =  ", 16, Italic, Bold], 
              Style[
               $CellContext`r[$CellContext`R$$], 16, Bold], 
              
              If[$CellContext`x[$CellContext`f$$, $CellContext`L$$, \
$CellContext`c$$] >= 0, 
               Style["+", 16, Bold], 
               Style["-", 16, Bold]], 
              Style[
               Abs[
                $CellContext`x[$CellContext`f$$, $CellContext`L$$, \
$CellContext`c$$]], 16, Bold], 
              Style["j", 16, Bold, Italic]}], {
             $CellContext`\[Xi][$CellContext`f$$, $CellContext`R$$, \
$CellContext`L$$, $CellContext`c$$], $CellContext`\[Eta][$CellContext`f$$, \
$CellContext`R$$, $CellContext`L$$, $CellContext`c$$] + 0.15}, Background -> 
            Directive[
              Opacity[0.3], Yellow]]]}], ImageSize -> {400, 400}], 
      "Specifications" :> {{{$CellContext`f$$, 500, "frequency MHz"}, 0, 1000,
          1, Appearance -> "Labeled", ImageSize -> 
         Tiny}, {{$CellContext`R$$, 50, "resistance \[CapitalOmega]"}, 0, 100,
          1, Appearance -> "Labeled", ImageSize -> 
         Tiny}, {{$CellContext`L$$, 10, "inductance nH"}, 0, 100, 1, 
         Appearance -> "Labeled", ImageSize -> 
         Tiny}, {{$CellContext`c$$, 10, "capacitance pF"}, 0, 100, 1, 
         Appearance -> "Labeled", ImageSize -> Tiny}}, 
      "Options" :> {
       TrackedSymbols -> Manipulate, ControlPlacement -> Left, 
        SynchronousInitialization -> False}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{469., {55., 60.}},
...
$CellContext`r[
          Pattern[$CellContext`X, 
           Blank[]], 
          Pattern[$CellContext`Y, 
           Blank[]]] := (1 - $CellContext`X^2 - $CellContext`Y^2)/(1 - 
         2 $CellContext`X + $CellContext`X^2 + $CellContext`Y^2); \
$CellContext`gx = ContourPlot[
          $CellContext`x[$CellContext`X, $CellContext`Y], {$CellContext`X, -1,
            0.999}, {$CellContext`Y, -1, 1}, ContourShading -> None, Contours -> 
          20, ContourStyle -> RGBColor[0.6, 0.73, 0.36], RegionFunction -> 
          Function[{$CellContext`X, $CellContext`Y}, 
            0 <= $CellContext`r[$CellContext`X, $CellContext`Y]], 
          PerformanceGoal -> "Quality"]; $CellContext`gr = ContourPlot[
          $CellContext`r[$CellContext`X, $CellContext`Y], {$CellContext`X, -1,
            0.999}, {$CellContext`Y, -1, 1}, ContourShading -> None, Contours -> 
          20, ContourStyle -> RGBColor[1, 0.47, 0], RegionFunction -> 
          Function[{$CellContext`X, $CellContext`Y}, 
            0 <= $CellContext`r[$CellContext`X, $CellContext`Y]], 
          PerformanceGoal -> "Quality"]; $CellContext`g0 = 
        Graphics[{Thick, Black, 
           Circle[], 
           Table[
            
            Line[{{1.01 Cos[$CellContext`n Pi], 1.01 
               Sin[$CellContext`n Pi]}, {
              1.02 Cos[$CellContext`n Pi], 1.02 
               Sin[$CellContext`n Pi]}}], {$CellContext`n, 0, 1.9, 0.1}], 
           Table[
            Text[
             Style[
             Mod[0.25 (1 - $CellContext`n), 0.5] "\[Lambda]", 10, Black], {
             1.15 Cos[$CellContext`n Pi], 1.15 
              Sin[$CellContext`n Pi]}], {$CellContext`n, 0, 1.9, 
             0.1}]}]; $CellContext`smith = 
        Show[$CellContext`gx, $CellContext`gr, $CellContext`g0, FrameTicks -> 
          None, Frame -> False, PlotRange -> 1.25]; $CellContext`r[
          Pattern[$CellContext`R, 
           Blank[]]] := Round[$CellContext`R/50, 0.1]; $CellContext`x[
          ...
          Pattern[$CellContext`c, 
           Blank[]]] := 
        Round[(1/
           50) ((((2 Pi) ($CellContext`f + 0.01)) $CellContext`L) 10^(-3) - 
           1/((((2 Pi) ($CellContext`f + 0.01)) ($CellContext`c + 0.01)) 
           10^(-6))), 0.1]; $CellContext`\[Xi][
          Pattern[$CellContext`f, 
           Blank[]], 
          Pattern[$CellContext`R, 
           Blank[]], 
          ...
          Pattern[$CellContext`c, 
           ...
           Blank[]]] := (-1 + $CellContext`r[$CellContext`R]^2 + \
$CellContext`x[$CellContext`f, $CellContext`L, $CellContext`c]^2)/((
...
$CellContext`\[Eta][
          ...
          Pattern[$CellContext`c, 
           Blank[]]] := 
        2 ($CellContext`x[$CellContext`f, $CellContext`L, $CellContext`c]/((
            1 + $CellContext`r[$CellContext`R])^2 + \
$CellContext`x[$CellContext`f, $CellContext`L, $CellContext`c]^2)); Null}; 
...
Cell["\<\
The Smith chart was developed by the electrical engineer Phillip H. Smith \
around 1939. It is a useful graphical aid for matching impedances of circuit \
elements, to optimize their performance.\
\>", "ManipulateCaption",
 CellID->619063987],

Cell[TextData[{
 "A Smith chart is a plot in the complex plane giving the real and imaginary \
parts of the complex voltage reflection coefficient \[CapitalGamma]. The \
contour lines on the chart represent values of the normalized resistance ",
 Cell[BoxData[
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{"Z", "=", 
    RowBox[{"R", "+", 
     RowBox[{"j", " ", "X", Cell["", "InlineMath"]}]}]}], TraditionalForm]], 
  "InlineMath"],
 ",  ",
 Cell[BoxData[
  FormBox[
   RowBox[{"X", "=", 
    RowBox[{
     RowBox[{"2", "\[Pi]", " ", "f", " ", "L"}], "-", 
     FractionBox["1", 
      RowBox[{"2", "\[Pi]", " ", "f", " ", "C"}]]}]}], TraditionalForm]], 
  "InlineMath"],
 ",\nand ",
 Cell[BoxData[
  FormBox[
   SubscriptBox["Z", "0"], TraditionalForm]], "InlineMath",
  FontSize->12],
 " is a characteristic impedance, often chosen as a resistance of 50\
\[CapitalOmega]. Note that electrical engineers use ",
 Cell[BoxData[
 ...
 Cell[BoxData[
  ...
  FontSize->12],
 ". The circumference of the chart gives the relative phase of the reflection \
coefficient, expressed as a multiple of the signal wavelength \[Lambda]. This \
is useful in determining the length of transmission lines, so as to enable \
standing waves."
}], "ManipulateCaption",
 FontSize->12,
 CellID->1517887546],
...
Cell[TextData[{
 ...
 " in ohms \[CapitalOmega]), inductance (",
 Cell[BoxData[
 ...
 " F) of the circuit element, as well as the frequency of the propagated \
signal (",
 Cell[BoxData[
  FormBox[
...
Cell["\<\
Snapshot 1: reactance equals zero when capacitive and inductive contributions \
cancel\
\>", "DetailNotes",
 CellID->882690730],

Cell[TextData[{
 "Snapshot 2: increasing inductive reactance (by increasing ",
 Cell[BoxData[
  FormBox["C", TraditionalForm]], "InlineMath"],
 " or ",
 Cell[BoxData[
  FormBox["L", TraditionalForm]], "InlineMath"],
 ") gives a clockwise rotation about a red circle contour; increasing \
capacitive reactance would result in a counterclockwise rotation"
}], "DetailNotes",
 CellID->1044087081],

Cell["\<\
Snapshot 3: the circumference of the Smith chart represents a resistance of \
zero\
\>", "DetailNotes",
 CellID->566065634],

Cell[TextData[{
 "A more complete, full-scale Smith chart is given on this ",
 ButtonBox["website",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://www.sss-mag.com/pdf/smithchart.pdf"], None}],
 ". See also: P. H. Smith, ",
 StyleBox["Electronic Applications of the Smith Chart in Waveguide: Circuit \
and Component Analysis",
  FontSlant->"Italic"],
 ", 2nd ed., Raleigh, NC: SciTech Publishing, 2000."
}], "DetailNotes",
 CellID->1399871837],
...
TheSmithChart&version=0018"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/TheSmithChart/TheSmithChart-source.nb"]]\
...
Cell[TextData[{
 ...
 ButtonBox["http://demonstrations.wolfram.com/TheSmithChart/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/TheSmithChart/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/TheSmithChart/"]
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[46198, 876, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[46459, 885, 691, 15, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[54222, 1069, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 80889, 1638},
 {"Copyright", 81083, 1643}
 }
*)
(*NotebookFileOutline
Notebook[{
...
Cell[34949, 592, 7539, 162, 70, "Output",
 CellID->134193449],
Cell[42491, 756, 252, 5, 70, "ManipulateCaption",
 CellID->619063987],
Cell[42746, 763, 2354, 74, 70, "ManipulateCaption",
 CellID->1517887546],
Cell[45103, 839, 1092, 35, 70, "ManipulateCaption",
 CellID->2055502709],
Cell[46198, 876, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[46459, 885, 691, 15, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[47153, 902, 33, 0, 70, "DetailsSection"],
Cell[47189, 904, 137, 4, 70, "DetailNotes",
 CellID->882690730],
Cell[47329, 910, 393, 10, 70, "DetailNotes",
 CellID->1044087081],
Cell[47725, 922, 133, 4, 70, "DetailNotes",
 CellID->566065634],
Cell[47861, 928, 453, 12, 70, "DetailNotes",
 CellID->1399871837],
Cell[48317, 942, 4778, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[53098, 1033, 45, 0, 70, "CitationSection"],
Cell[53146, 1035, 743, 20, 70, "Citations"],
Cell[53892, 1057, 327, 10, 70, "Author"],
Cell[54222, 1069, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature ZTayIc7PbnVIdvQvgqp9u@Uv *)
